...
/**
 * This function is in charge of testing the methods of the BusinessObject
 * Class.
 * 
 * @author Nam Kyu Lee.
 */
class BusinessObjectTest {
	...
	BusinessObject bo = new BusinessObject(petitionerLastName, petitionerFirstName, businessName, address, phoneNumber,
			email, EIN, beneficiaryLastName, beneficiaryFirstName, beneficiaryDOB, beneficiaryGender,
			beneficiaryA_Number, beneficiaryCountryOfBirth, beneficiaryAddress, beneficiaryArrivalDate,
			beneficiaryPassportExpirationDate, workID);
	...
	public void testGetBeneficiaryFirstName() {
		assertEquals("This should return beneficiary's first name.", beneficiaryFirstName,
				bo.getBeneficiaryFirstName());
	}
	...
	public void testGetBeneficiaryCountryOfBirth() {
		assertEquals("This should return beneficiary's country of birth.", beneficiaryCountryOfBirth,
				bo.getBeneficiaryCountryOfBirth());
	}
	...
	public void testGetBeneficiaryArrivalDate() {
		assertEquals("This should return beneficiary's arrival date.", beneficiaryArrivalDate,
				bo.getBeneficiaryArrivalDate());
	}
	...
	public void testGetBeneficiaryPassportExpirationDate() {
		assertEquals("This should return beneficiary's passport expiration date.", beneficiaryPassportExpirationDate,
				bo.getBeneficiaryPassportExpirationDate());
	}
	 ...
	 * 
	 * @Test public void testGetCurrentStep() { assertEquals("This should return
	 *       current step.", currentStep, bo.getCurrentStep()); }
	 * 
	 */
	...
	public void testSetBeneficiaryCountryOfBirth() {
		...
		assertEquals("This should set beneficiary's country of birth.", bCountryOfBirth,
				bo.getBeneficiaryCountryOfBirth());
	}
	...
	public void testSetBeneficiaryPassportExpirationDate() {
		...
		assertEquals("This should set beneficiary's passport expiration date.", bPassportExpirationDate,
				bo.getBeneficiaryPassportExpirationDate());
	}
